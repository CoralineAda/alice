  ...
  class Randomizer
    ...
    def self.forge
      [
        ...
        "in a #{Util::Randomizer.illumination} room",
        "in a #{Util::Randomizer.illumination} workshop",
        "in a #{Util::Randomizer.illumination} laboratory",
        "cooled in a bucket of #{Util::Randomizer.beverage}",
        "under bright #{color} halogen lights",
        "plucked from the bowels of the #{Util::Randomizer.type_of_place}",
    ...
    def self.actor_description(name)
      [
        ...
        "a #{name} with the look of someone who just escaped a cut-throat game of #{Util::Randomizer.game}.",
        "an elegant figure, resplendent in fine, hand-tailored clothing.",
        "strangely similar to #{Util::Randomizer.person}",
        "tall, dark, and handsome.",
        "good-looking and out for a wild night at the #{Util::Randomizer.type_of_place}.",
        "grim-faced and resolute.",
        "a lean, hungry-looking person.",
        "yet another average #{name} from the #{Util::Randomizer.type_of_place}.",
        "a friendy face from the #{Util::Randomizer.type_of_place}.",
        "a good-natured sort with a broad, friendly smile.",
        "an old-fashioned sort with a heart of gold.",
        "a spitting image of #{Util::Randomizer.person}",
        "the grown-up version of #{Util::Randomizer.person}.",
        "the kind of person you'd expect to meet iin the #{Util::Randomizer.type_of_place}.",
        "just another sucker on the vine.",
        "just another restless soul.",
        "not the kind of person you were expecting.",
        "perfectly average, except for their immense #{Util::Randomizer.body_thing}.",
        "perfectly average, except for their rather small #{Util::Randomizer.body_thing}.",
        "a gaunt figure who fills the room with their presence.",
        "a rather shy person with flushed cheeks.",
        "the kind of person who plays too much #{Util::Randomizer.game}.",
        "someone who would enjoy a good game of #{Util::Randomizer.game}.",
        "somone you could get #{Util::Randomizer.thing} from at short notice.",
        "short and stocky, like most hobbits.",
        "just a delicate desert flower.",
        "the very model of a modern major general.",
        "perfect in every detail, except for their odd #{Util::Randomizer.body_thing}.",
        "not much to look at, except for their amazingly beautiful #{Util::Randomizer.body_thing}.",
        "a genius by any measure.",
        "#{Util::Randomizer.person}.",
        "a movie star.",
        ...
        "this generation's version of #{Util::Randomizer.person}.",
        "someone's idea of #{Util::Randomizer.person}.",
        "#{Util::Randomizer.person} but with #{Util::Randomizer.person}'s #{Util::Randomizer.body_thing}."
      ].sample
    end
    ...
    def self.specific_person
      [
        ...
        "Douglas",
        "The #{Util::Randomizer.nth} Doctor",
        "Rapunzel",
        "The #{Util::Randomizer.color.capitalize} Power Ranger",
        "Wonder Woman",
        "Jane Goodall",
    ...
    def self.person
      [
        Util::Randomizer.specific_person,
        Util::Randomizer.specific_person,
        Util::Randomizer.specific_person,
        Util::Randomizer.specific_person,
        Util::Randomizer.specific_person,
    ...
    def self.effect_message(item_name, actor_name)
      [
        ...
        "#{actor_name} feels a strong urge to travel #{Util::Randomizer.random_direction}ward.",
        "#{actor_name} hears a strange voice calling from somewhere to the #{Util::Randomizer.random_direction}.",
